...
public class PaintCanvas extends JPanel implements MouseListener, MouseMotionListener {
    ...
    private final ArrayList<Strokes> strokes = new ArrayList<>();
    ...
    public UndoTool getUndoTool() { return undoTool; }

    public RedoTool getRedoTool() { return redoTool; }

    public DropperTool getDropperTool() { return dropperTool; }
    ...
    public void setLineThickness(int thickness) { this.lineThickness = thickness; }
    ...
    public void setRedoTool(RedoTool tool) { this.redoTool = tool; }

    public void setColorPalette(ColorPalette palette) { this.colorPalette = palette; }

    public void setDrawTool(DrawTool tool) { this.drawTool = tool; }

    public DrawTool getDrawTool() {
        return drawTool;
    }

    public void setEraserTool(EraserTool tool) { this.eraseTool = tool; }

    public void setFillTool(FillTool tool) { this.fillTool = tool; }

    public void setDropperTool(DropperTool tool) { this.dropperTool = tool; }

    public void addStroke(Strokes stroke) { strokes.add(stroke); }

    public void setActiveDrawTool(DrawTool tool) { this.drawTool = tool; }

    public void setActiveEraserTool(EraserTool tool) { this.eraseTool = tool; }
